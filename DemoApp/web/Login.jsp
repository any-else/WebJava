...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Oct 2020 11:48:30 GMT -->
            ...
            <div class="login-box">
                ...
                <form action="Controller" method="POST" class="login-form">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtUser" placeholder="Enter usrename" class="form-control">
